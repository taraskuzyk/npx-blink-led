...
pub type PtcoR = crate::FieldReader<Ptco>;
impl PtcoR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ptco> {
        match self.bits {
            0 => Some(Ptco::B00000000000000000000000000000000),
            1 => Some(Ptco::B00000000000000000000000000000001),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u32>,
{
    ...
    pub fn b00000000000000000000000000000000(self) -> &'a mut crate::W<REG> {
        self.variant(Ptco::B00000000000000000000000000000000)
    }
    #[doc = "Corresponding bit in PDORn is cleared to logic 0."]
    #[inline(always)]
    pub fn b00000000000000000000000000000001(self) -> &'a mut crate::W<REG> {
        self.variant(Ptco::B00000000000000000000000000000001)
    }
}
impl R {
    #[doc = "Bits 0:31 - Port Clear Output"]
    #[inline(always)]
    pub fn ptco(&self) -> PtcoR {
        PtcoR::new(self.bits)
    }
}
impl W {
