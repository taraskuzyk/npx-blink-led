...
impl From<Rfifoef> for bool {
    #[inline(always)]
    fn from(variant: Rfifoef) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RFIFOEF` reader - SPI read FIFO empty flag"]
pub type RfifoefR = crate::BitReader<Rfifoef>;
impl RfifoefR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Rfifoef {
        match self.bits {
            false => Rfifoef::B0,
            true => Rfifoef::B1,
        }
    }
    #[doc = "Read FIFO has data. Reads of the DH:DL registers in 16-bit mode or the DL register in 8-bit mode will empty the read FIFO."]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
        *self == Rfifoef::B0
    }
    #[doc = "Read FIFO is empty."]
    #[inline(always)]
...
impl From<Txfullf> for bool {
    #[inline(always)]
    fn from(variant: Txfullf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TXFULLF` reader - Transmit FIFO full flag"]
pub type TxfullfR = crate::BitReader<Txfullf>;
impl TxfullfR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Txfullf {
        match self.bits {
            false => Txfullf::B0,
            true => Txfullf::B1,
        }
    }
    #[doc = "Transmit FIFO has less than 8 bytes"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
        *self == Txfullf::B0
    }
    #[doc = "Transmit FIFO has 8 bytes of data"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
        *self == Txfullf::B1
    }
...
impl From<Tnearef> for bool {
    #[inline(always)]
    fn from(variant: Tnearef) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TNEAREF` reader - Transmit FIFO nearly empty flag"]
pub type TnearefR = crate::BitReader<Tnearef>;
impl TnearefR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tnearef {
        match self.bits {
            false => Tnearef::B0,
            true => Tnearef::B1,
        }
    }
    #[doc = "Transmit FIFO has more than 16 bits (when C3\\[TNEAREF_MARK\\]
is 0) or more than 32 bits (when C3\\[TNEAREF_MARK\\]
is 1) remaining to transmit"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
    ...
    #[doc = "Transmit FIFO has an amount of data equal to or less than 16 bits (when C3\\[TNEAREF_MARK\\]
is 0) or 32 bits (when C3\\[TNEAREF_MARK\\]
is 1) remaining to transmit"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
...
impl From<Rnfullf> for bool {
    #[inline(always)]
    fn from(variant: Rnfullf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RNFULLF` reader - Receive FIFO nearly full flag"]
pub type RnfullfR = crate::BitReader<Rnfullf>;
impl RnfullfR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Rnfullf {
        match self.bits {
            false => Rnfullf::B0,
            true => Rnfullf::B1,
        }
    }
    #[doc = "Receive FIFO has received less than 48 bits (when C3\\[RNFULLF_MARK\\]
is 0) or less than 32 bits (when C3\\[RNFULLF_MARK\\]
is 1)"]
    #[inline(always)]
    pub fn is_b0(&self) -> bool {
    ...
    #[doc = "Receive FIFO has received data of an amount equal to or greater than 48 bits (when C3\\[RNFULLF_MARK\\]
is 0) or 32 bits (when C3\\[RNFULLF_MARK\\]
is 1)"]
    #[inline(always)]
    pub fn is_b1(&self) -> bool {
...
impl R {
    ...
    #[inline(always)]
    pub fn rfifoef(&self) -> RfifoefR {
        RfifoefR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Transmit FIFO full flag"]
    #[inline(always)]
    pub fn txfullf(&self) -> TxfullfR {
        TxfullfR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Transmit FIFO nearly empty flag"]
    #[inline(always)]
    pub fn tnearef(&self) -> TnearefR {
        TnearefR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Receive FIFO nearly full flag"]
    #[inline(always)]
    pub fn rnfullf(&self) -> RnfullfR {
        RnfullfR::new(((self.bits >> 3) & 1) != 0)
    }
