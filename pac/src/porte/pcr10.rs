...
pub type R = crate::R<Pcr10Spec>;
#[doc = "Register `PCR10` writer"]
pub type W = crate::W<Pcr10Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr10Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr10Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr10Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr10Spec;
impl crate::RegisterSpec for Pcr10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr10::R`](R) reader structure"]
impl crate::Readable for Pcr10Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr10::W`](W) writer structure"]
impl crate::Writable for Pcr10Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR10 to value 0x05"]
impl crate::Resettable for Pcr10Spec {
