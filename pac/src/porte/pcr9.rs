...
pub type R = crate::R<Pcr9Spec>;
#[doc = "Register `PCR9` writer"]
pub type W = crate::W<Pcr9Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr9Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr9Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr9Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr9Spec;
impl crate::RegisterSpec for Pcr9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr9::R`](R) reader structure"]
impl crate::Readable for Pcr9Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr9::W`](W) writer structure"]
impl crate::Writable for Pcr9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR9 to value 0x05"]
impl crate::Resettable for Pcr9Spec {
