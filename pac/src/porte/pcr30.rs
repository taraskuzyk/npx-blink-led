...
pub type R = crate::R<Pcr30Spec>;
#[doc = "Register `PCR30` writer"]
pub type W = crate::W<Pcr30Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<Pcr30Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<Pcr30Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Slew Rate Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SreW<Pcr30Spec> {
        SreW::new(self, 2)
    }
    #[doc = "Bits 8:10 - Pin Mux Control"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr30Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr30Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr30Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr30Spec;
impl crate::RegisterSpec for Pcr30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr30::R`](R) reader structure"]
impl crate::Readable for Pcr30Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr30::W`](W) writer structure"]
impl crate::Writable for Pcr30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR30 to value 0x05"]
impl crate::Resettable for Pcr30Spec {
