...
pub type R = crate::R<Pcr27Spec>;
#[doc = "Register `PCR27` writer"]
pub type W = crate::W<Pcr27Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr27Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr27Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr27Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr27Spec;
impl crate::RegisterSpec for Pcr27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr27::R`](R) reader structure"]
impl crate::Readable for Pcr27Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr27::W`](W) writer structure"]
impl crate::Writable for Pcr27Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR27 to value 0x05"]
impl crate::Resettable for Pcr27Spec {
