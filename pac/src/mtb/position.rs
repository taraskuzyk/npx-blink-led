...
#[doc = "Field `WRAP` reader - WRAP"]
pub type WrapR = crate::BitReader;
#[doc = "Field `WRAP` writer - WRAP"]
pub type WrapW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `POINTER` reader - Trace Packet Address Pointer\\[28:0\\]"]
pub type PointerR = crate::FieldReader<u32>;
#[doc = "Field `POINTER` writer - Trace Packet Address Pointer\\[28:0\\]"]
...
impl R {
    ...
    #[doc = "Bits 3:31 - Trace Packet Address Pointer\\[28:0\\]"]
    #[inline(always)]
