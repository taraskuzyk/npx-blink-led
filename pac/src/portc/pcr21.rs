...
pub type R = crate::R<Pcr21Spec>;
#[doc = "Register `PCR21` writer"]
pub type W = crate::W<Pcr21Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<Pcr21Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<Pcr21Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Slew Rate Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SreW<Pcr21Spec> {
        SreW::new(self, 2)
    }
    #[doc = "Bits 8:10 - Pin Mux Control"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr21Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr21Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr21Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr21Spec;
impl crate::RegisterSpec for Pcr21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr21::R`](R) reader structure"]
impl crate::Readable for Pcr21Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr21::W`](W) writer structure"]
impl crate::Writable for Pcr21Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR21 to value 0x05"]
impl crate::Resettable for Pcr21Spec {
