...
pub type R = crate::R<Pcr16Spec>;
#[doc = "Register `PCR16` writer"]
pub type W = crate::W<Pcr16Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<Pcr16Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<Pcr16Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Slew Rate Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SreW<Pcr16Spec> {
        SreW::new(self, 2)
    }
    #[doc = "Bits 8:10 - Pin Mux Control"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr16Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr16Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr16Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr16Spec;
impl crate::RegisterSpec for Pcr16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr16::R`](R) reader structure"]
impl crate::Readable for Pcr16Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr16::W`](W) writer structure"]
impl crate::Writable for Pcr16Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR16 to value 0x01"]
impl crate::Resettable for Pcr16Spec {
