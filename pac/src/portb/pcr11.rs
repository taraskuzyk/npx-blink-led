...
pub type R = crate::R<Pcr11Spec>;
#[doc = "Register `PCR11` writer"]
pub type W = crate::W<Pcr11Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr11Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr11Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr11Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr11Spec;
impl crate::RegisterSpec for Pcr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr11::R`](R) reader structure"]
impl crate::Readable for Pcr11Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr11::W`](W) writer structure"]
impl crate::Writable for Pcr11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR11 to value 0x01"]
impl crate::Resettable for Pcr11Spec {
