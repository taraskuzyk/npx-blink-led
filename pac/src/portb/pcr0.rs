...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<Pcr0Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<Pcr0Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Slew Rate Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SreW<Pcr0Spec> {
        SreW::new(self, 2)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dse(&mut self) -> DseW<Pcr0Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bits 8:10 - Pin Mux Control"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr0Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr0Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr0Spec> {
        IsfW::new(self, 24)
    }
}
...
#[doc = "`reset()` method sets PCR0 to value 0x05"]
