...
pub type R = crate::R<Pcr8Spec>;
#[doc = "Register `PCR8` writer"]
pub type W = crate::W<Pcr8Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr8Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr8Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr8Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr8Spec;
impl crate::RegisterSpec for Pcr8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr8::R`](R) reader structure"]
impl crate::Readable for Pcr8Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr8::W`](W) writer structure"]
impl crate::Writable for Pcr8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR8 to value 0x05"]
impl crate::Resettable for Pcr8Spec {
