...
pub type R = crate::R<Pcr28Spec>;
#[doc = "Register `PCR28` writer"]
pub type W = crate::W<Pcr28Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr28Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr28Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr28Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr28Spec;
impl crate::RegisterSpec for Pcr28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr28::R`](R) reader structure"]
impl crate::Readable for Pcr28Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr28::W`](W) writer structure"]
impl crate::Writable for Pcr28Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR28 to value 0x05"]
impl crate::Resettable for Pcr28Spec {
