...
pub type R = crate::R<Pcr15Spec>;
#[doc = "Register `PCR15` writer"]
pub type W = crate::W<Pcr15Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr15Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr15Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr15Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr15Spec;
impl crate::RegisterSpec for Pcr15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr15::R`](R) reader structure"]
impl crate::Readable for Pcr15Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr15::W`](W) writer structure"]
impl crate::Writable for Pcr15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR15 to value 0x01"]
impl crate::Resettable for Pcr15Spec {
