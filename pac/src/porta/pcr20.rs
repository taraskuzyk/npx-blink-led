...
pub type R = crate::R<Pcr20Spec>;
#[doc = "Register `PCR20` writer"]
pub type W = crate::W<Pcr20Spec>;
#[doc = "Pull Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ps(&mut self) -> PsW<Pcr20Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pe(&mut self) -> PeW<Pcr20Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Slew Rate Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SreW<Pcr20Spec> {
        SreW::new(self, 2)
    }
    #[doc = "Bit 4 - Passive Filter Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pfe(&mut self) -> PfeW<Pcr20Spec> {
        PfeW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Pin Mux Control"]
    #[inline(always)]
    #[must_use]
    pub fn mux(&mut self) -> MuxW<Pcr20Spec> {
        MuxW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Interrupt Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn irqc(&mut self) -> IrqcW<Pcr20Spec> {
        IrqcW::new(self, 16)
    }
    #[doc = "Bit 24 - Interrupt Status Flag"]
    #[inline(always)]
    #[must_use]
    pub fn isf(&mut self) -> IsfW<Pcr20Spec> {
        IsfW::new(self, 24)
    }
}
...
pub struct Pcr20Spec;
impl crate::RegisterSpec for Pcr20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pcr20::R`](R) reader structure"]
impl crate::Readable for Pcr20Spec {}
#[doc = "`write(|w| ..)` method takes [`pcr20::W`](W) writer structure"]
impl crate::Writable for Pcr20Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PCR20 to value 0x0717"]
impl crate::Resettable for Pcr20Spec {
    const RESET_VALUE: u32 = 0x0717;
}
