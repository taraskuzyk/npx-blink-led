...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpwe0(&mut self) -> Gpwe0W<GpchrSpec> {
        Gpwe0W::new(self, 16)
    }
    #[doc = "Bit 17 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe1(&mut self) -> Gpwe1W<GpchrSpec> {
        Gpwe1W::new(self, 17)
    }
    #[doc = "Bit 18 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe2(&mut self) -> Gpwe2W<GpchrSpec> {
        Gpwe2W::new(self, 18)
    }
    #[doc = "Bit 19 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe3(&mut self) -> Gpwe3W<GpchrSpec> {
        Gpwe3W::new(self, 19)
    }
    #[doc = "Bit 20 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe4(&mut self) -> Gpwe4W<GpchrSpec> {
        Gpwe4W::new(self, 20)
    }
    #[doc = "Bit 21 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe5(&mut self) -> Gpwe5W<GpchrSpec> {
        Gpwe5W::new(self, 21)
    }
    #[doc = "Bit 22 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe6(&mut self) -> Gpwe6W<GpchrSpec> {
        Gpwe6W::new(self, 22)
    }
    #[doc = "Bit 23 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe7(&mut self) -> Gpwe7W<GpchrSpec> {
        Gpwe7W::new(self, 23)
    }
    #[doc = "Bit 24 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe8(&mut self) -> Gpwe8W<GpchrSpec> {
        Gpwe8W::new(self, 24)
    }
    #[doc = "Bit 25 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe9(&mut self) -> Gpwe9W<GpchrSpec> {
        Gpwe9W::new(self, 25)
    }
    #[doc = "Bit 26 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe10(&mut self) -> Gpwe10W<GpchrSpec> {
        Gpwe10W::new(self, 26)
    }
    #[doc = "Bit 27 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe11(&mut self) -> Gpwe11W<GpchrSpec> {
        Gpwe11W::new(self, 27)
    }
    #[doc = "Bit 28 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe12(&mut self) -> Gpwe12W<GpchrSpec> {
        Gpwe12W::new(self, 28)
    }
    #[doc = "Bit 29 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe13(&mut self) -> Gpwe13W<GpchrSpec> {
        Gpwe13W::new(self, 29)
    }
    #[doc = "Bit 30 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe14(&mut self) -> Gpwe14W<GpchrSpec> {
        Gpwe14W::new(self, 30)
    }
    #[doc = "Bit 31 - Global Pin Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gpwe15(&mut self) -> Gpwe15W<GpchrSpec> {
        Gpwe15W::new(self, 31)
    }
}
