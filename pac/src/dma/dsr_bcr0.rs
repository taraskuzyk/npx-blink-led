#[doc = "Register `DSR_BCR0` reader"]
pub type R = crate::R<DsrBcr0Spec>;
#[doc = "Register `DSR_BCR0` writer"]
pub type W = crate::W<DsrBcr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bcr(&mut self) -> BcrW<DsrBcr0Spec> {
        BcrW::new(self, 0)
    }
    #[doc = "Bit 24 - Transactions Done"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<DsrBcr0Spec> {
        DoneW::new(self, 24)
    }
}
...
pub struct DsrBcr0Spec;
impl crate::RegisterSpec for DsrBcr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsr_bcr0::R`](R) reader structure"]
impl crate::Readable for DsrBcr0Spec {}
#[doc = "`write(|w| ..)` method takes [`dsr_bcr0::W`](W) writer structure"]
impl crate::Writable for DsrBcr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSR_BCR0 to value 0"]
impl crate::Resettable for DsrBcr0Spec {
