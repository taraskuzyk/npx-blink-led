#[doc = "Register `DSR_BCR1` reader"]
pub type R = crate::R<DsrBcr1Spec>;
#[doc = "Register `DSR_BCR1` writer"]
pub type W = crate::W<DsrBcr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bcr(&mut self) -> BcrW<DsrBcr1Spec> {
        BcrW::new(self, 0)
    }
    #[doc = "Bit 24 - Transactions Done"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<DsrBcr1Spec> {
        DoneW::new(self, 24)
    }
}
...
pub struct DsrBcr1Spec;
impl crate::RegisterSpec for DsrBcr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsr_bcr1::R`](R) reader structure"]
impl crate::Readable for DsrBcr1Spec {}
#[doc = "`write(|w| ..)` method takes [`dsr_bcr1::W`](W) writer structure"]
impl crate::Writable for DsrBcr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSR_BCR1 to value 0"]
impl crate::Resettable for DsrBcr1Spec {
