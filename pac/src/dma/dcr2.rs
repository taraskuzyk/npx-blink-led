...
pub type R = crate::R<Dcr2Spec>;
#[doc = "Register `DCR2` writer"]
pub type W = crate::W<Dcr2Spec>;
#[doc = "Link Channel 2\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lch2(&mut self) -> Lch2W<Dcr2Spec> {
        Lch2W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Link Channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn lch1(&mut self) -> Lch1W<Dcr2Spec> {
        Lch1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Link Channel Control"]
    #[inline(always)]
    #[must_use]
    pub fn linkcc(&mut self) -> LinkccW<Dcr2Spec> {
        LinkccW::new(self, 4)
    }
    #[doc = "Bit 7 - Disable Request"]
    #[inline(always)]
    #[must_use]
    pub fn d_req(&mut self) -> DReqW<Dcr2Spec> {
        DReqW::new(self, 7)
    }
    #[doc = "Bits 8:11 - Destination Address Modulo"]
    #[inline(always)]
    #[must_use]
    pub fn dmod(&mut self) -> DmodW<Dcr2Spec> {
        DmodW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Source Address Modulo"]
    #[inline(always)]
    #[must_use]
    pub fn smod(&mut self) -> SmodW<Dcr2Spec> {
        SmodW::new(self, 12)
    }
    #[doc = "Bit 16 - Start Transfer"]
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> StartW<Dcr2Spec> {
        StartW::new(self, 16)
    }
    #[doc = "Bits 17:18 - Destination Size"]
    #[inline(always)]
    #[must_use]
    pub fn dsize(&mut self) -> DsizeW<Dcr2Spec> {
        DsizeW::new(self, 17)
    }
    #[doc = "Bit 19 - Destination Increment"]
    #[inline(always)]
    #[must_use]
    pub fn dinc(&mut self) -> DincW<Dcr2Spec> {
        DincW::new(self, 19)
    }
    #[doc = "Bits 20:21 - Source Size"]
    #[inline(always)]
    #[must_use]
    pub fn ssize(&mut self) -> SsizeW<Dcr2Spec> {
        SsizeW::new(self, 20)
    }
    #[doc = "Bit 22 - Source Increment"]
    #[inline(always)]
    #[must_use]
    pub fn sinc(&mut self) -> SincW<Dcr2Spec> {
        SincW::new(self, 22)
    }
    #[doc = "Bit 23 - Enable asynchronous DMA requests"]
    #[inline(always)]
    #[must_use]
    pub fn eadreq(&mut self) -> EadreqW<Dcr2Spec> {
        EadreqW::new(self, 23)
    }
    #[doc = "Bit 28 - Auto-align"]
    #[inline(always)]
    #[must_use]
    pub fn aa(&mut self) -> AaW<Dcr2Spec> {
        AaW::new(self, 28)
    }
    #[doc = "Bit 29 - Cycle Steal"]
    #[inline(always)]
    #[must_use]
    pub fn cs(&mut self) -> CsW<Dcr2Spec> {
        CsW::new(self, 29)
    }
    #[doc = "Bit 30 - Enable Peripheral Request"]
    #[inline(always)]
    #[must_use]
    pub fn erq(&mut self) -> ErqW<Dcr2Spec> {
        ErqW::new(self, 30)
    }
    #[doc = "Bit 31 - Enable Interrupt on Completion of Transfer"]
    #[inline(always)]
    #[must_use]
    pub fn eint(&mut self) -> EintW<Dcr2Spec> {
        EintW::new(self, 31)
    }
}
