#[doc = "Register `DSR_BCR3` reader"]
pub type R = crate::R<DsrBcr3Spec>;
#[doc = "Register `DSR_BCR3` writer"]
pub type W = crate::W<DsrBcr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bcr(&mut self) -> BcrW<DsrBcr3Spec> {
        BcrW::new(self, 0)
    }
    #[doc = "Bit 24 - Transactions Done"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<DsrBcr3Spec> {
        DoneW::new(self, 24)
    }
}
...
pub struct DsrBcr3Spec;
impl crate::RegisterSpec for DsrBcr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dsr_bcr3::R`](R) reader structure"]
impl crate::Readable for DsrBcr3Spec {}
#[doc = "`write(|w| ..)` method takes [`dsr_bcr3::W`](W) writer structure"]
impl crate::Writable for DsrBcr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DSR_BCR3 to value 0"]
impl crate::Resettable for DsrBcr3Spec {
