    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn b00(self) -> &'a mut crate::W<REG> {
        self.variant(Hystctr::B00)
    }
    #[doc = "Level 1"]
    #[inline(always)]
    pub fn b01(self) -> &'a mut crate::W<REG> {
        self.variant(Hystctr::B01)
    }
    #[doc = "Level 2"]
    #[inline(always)]
    pub fn b10(self) -> &'a mut crate::W<REG> {
        self.variant(Hystctr::B10)
    }
    #[doc = "Level 3"]
    #[inline(always)]
    pub fn b11(self) -> &'a mut crate::W<REG> {
        self.variant(Hystctr::B11)
    }
}
...
#[repr(u8)]
pub enum FilterCnt {
    #[doc = "0: Filter is disabled. SE = 0, COUT = COUTA."]
    B000 = 0,
...
impl FilterCntR {
    ...
    #[doc = "Filter is disabled. SE = 0, COUT = COUTA."]
    #[inline(always)]
