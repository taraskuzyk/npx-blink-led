...
#[doc = "Field `CRC5` reader - This error interrupt has two functions"]
pub type Crc5R = crate::BitReader;
#[doc = "Field `CRC5` writer - This error interrupt has two functions"]
pub type Crc5W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn crc5(&self) -> Crc5R {
        Crc5R::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crc5(&mut self) -> Crc5W<ErrstatSpec> {
        Crc5W::new(self, 1)
    }
    #[doc = "Bit 2 - This bit is set when a data packet is rejected due to a CRC16 error."]
    #[inline(always)]
